...
#SBATCH --partition=tmp,gpu
#SBATCH --time=10000
#SBATCH --exclude=xe8545-a100-06
#SBATCH --array=1-91

set -euo pipefail

CMD_FILE=/home/c02sara/CISPA-az6/dgdlm-2024/higher_interpolant_matching/SDE_exp_validation.txt
...
srun --container-image=projects.cispa.saarland:5005#c02sara/dynamic_and_geometric_models:torch_flow_matching_v17 \
     ...
     python /home/c02sara/CISPA-az6/dgdlm-2024/higher_interpolant_matching/evaluation.py $ARGS